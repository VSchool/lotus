...
const FooterPageHeaderContainer = styled.div`
    display: flex;
    /* border: 1px solid blue; */
`

const FooterPageTitle = styled.p`
    margin: 0px;
    font-family: Roboto;
    font-style: normal;
    font-weight: normal;
...
const FooterPageDescription = styled.p`
...
const FooterPageSubHeader = styled.p`
    ...
    return (
        <FooterExampleContainer>
            <FooterPageHeaderContainer>
                <FooterPageTitle>Footer</FooterPageTitle>
